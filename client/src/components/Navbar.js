...
import { Navbar, Nav, Container, Modal, Tab } from "react-bootstrap"; // import bootstrap components
import SignUpForm from "./SignupForm"; // import SignupForm component
import LoginForm from "./LoginForm"; // import LoginForm component
import Auth from "../utils/auth"; // import auth.js

const AppNavbar = () => {
  // define AppNavbar functional component
  const [showModal, setShowModal] = useState(false); // set showModal state to false
